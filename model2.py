...
for hold_x_out in [5,3,1]: #the number of images to hold out for each test (defines the training set)
    newfile = feature_set + '_T1andT2_200_MLP_cell_results_L' + str(hold_x_out) + 'O.csv' #where results will be printed
    ...
    for transfer in range(1,4):#total_transfers+1): #run on first half
        #reset learning rate
