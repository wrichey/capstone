...
for hold_x_out in [3,5]: #the number of images to hold out for each test (defines the training set)
    newfile = feature_set + '_T1andT2_100_MLP_cell_results_L' + str(hold_x_out) + 'O.csv' #where results will be printed
    ...
    for transfer in range(1,3):#total_transfers+1): #run on first half
        #reset learning rate
